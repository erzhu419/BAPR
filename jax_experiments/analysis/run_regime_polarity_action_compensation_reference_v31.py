"""Train the frozen-recipe V31 canonical mode-0 reference policy."""
...
from jax_experiments.analysis import (
    regime_polarity_action_compensation_reference_v31 as protocol,
)
from jax_experiments.analysis import (
    run_regime_polarity_action_compensation_source_v31 as source_runner,
)
from jax_experiments.analysis import (
