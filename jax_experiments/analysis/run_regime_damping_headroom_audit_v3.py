"""Rerun one failed robust audit under the corrected v3 trace contract."""
...
from jax_experiments.analysis import (
    run_regime_damping_headroom_controller_v2 as v2_controller,
)


common.protocol = protocol
common.validate_bundle = v2_controller.validate_bundle
...
def main() -> None:
    ...
    parser.add_argument("--role", choices=("robust",), required=True)
