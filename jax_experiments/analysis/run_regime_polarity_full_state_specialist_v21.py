"""Train one frozen-recipe V21 full-state-final specialist."""
from __future__ import annotations

import argparse

from jax_experiments.analysis import (
    regime_polarity_full_state_specialist_v21 as protocol,
)
from jax_experiments.analysis import (
    run_regime_polarity_robust_source_v21 as source_runner,
)
from jax_experiments.analysis import (
...
def run(seed: int, mode: int) -> None:
    _bind()
    base.run(protocol.SPECIALIST_VARIANT, seed, mode)
