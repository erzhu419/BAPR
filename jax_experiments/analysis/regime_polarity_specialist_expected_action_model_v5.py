"""Construction and loading for specialist-trajectory system ID v5."""
...
def load_model(obs_dim: int, act_dim: int):
    ...
    if (
        ...
        raise ValueError("invalid specialist-trajectory system-ID model")
    ...
    if (
        ...
        raise ValueError("invalid specialist estimator calibration arrays")
