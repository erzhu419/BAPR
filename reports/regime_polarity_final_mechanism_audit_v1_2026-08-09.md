# Superseded final BAPR mechanism audit protocol

This v1 registration was cancelled before valid results were produced because
its source closure omitted indirect runtime modules. Scheduler tasks
`t79045-t79070` were force-cancelled. The complete transitive registration is
v2 in `regime_polarity_final_mechanism_audit_v2_2026-08-09.md`.
