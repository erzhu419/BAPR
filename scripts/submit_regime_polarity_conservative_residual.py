#!/usr/bin/env python3
"""Submit the conservative frozen-residual v3 development matrix."""
...
SIGNATURE_PREFIX = "BAPR/regime-polarity-conservative-residual/v3"
DISPLAY_NAME = "Conservative residual v3"
RESOURCE_PREFIX = "BAPR/regime-polarity-conservative-residual"
BRANCH_MODULE = (
    "jax_experiments.analysis."
    "run_regime_polarity_conservative_residual_branch")
CALIBRATION_MODULE = (
    "jax_experiments.analysis."
    "calibrate_regime_polarity_conservative_residual")
AUDIT_MODULE = (
    "jax_experiments.analysis."
    "audit_regime_polarity_conservative_residual")
ANALYSIS_MODULE = (
    "jax_experiments.analysis."
    "analyze_regime_polarity_conservative_residual")
TRAIN_BRANCH_ROLES = protocol.VARIANTS
SUBMIT_INTENT_LABEL = "bapr-conservative-residual-v3-submit"
DISPATCH_INTENT_LABEL = "bapr-conservative-residual-v3-dispatch"
